        ...
        <div class="widget-content">
            ...
            <form class="form-horizontal">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input id="Kode_lembur" type="text" class="span11" name="Kode_lembur" value="{{ $kategori_lembur->Kode_lembur }}" readonly />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Kode Jabatan :</label>
                  <div class="controls">
                    <input id="Kode_jabatan" type="text" class="span11" name="Kode_jabatan" value="{{ $kategori_lembur->Jabatan->Nama_jabatan }}" readonly />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Kode Golongan :</label>
                  <div class="controls">
                    <input id="Kode_golongan" type="text" class="span11" name="Kode_golongan" value="{{ $kategori_lembur->Golongan->Nama_golongan }}" readonly />
                  </div>
                </div>
                <div class="control-group">
